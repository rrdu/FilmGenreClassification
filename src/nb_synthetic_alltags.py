...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and evaluate Naive Bayes on synthetic data (all tags)."
    )
    ...
    parser.add_argument(
        ...
        default=str(
            ...
            / "data"
            / "synthetic"
            / "nb_synthetic_mpst_alltags.csv"
        ),
        help="Path to the synthetic CSV (all tags) generated from the MPST NB model.",
    )
...
def main():
    ...
    all_genres = sorted(set(y_train) | set(y_val) | set(y_test))
    ...
    #Save model
    model_path = "saved_models/nb_synthetic_alltags.pkl"
